...
public class ForkJoinPoolForking {
        ...
        public static class TestState {
            ...
            public void setup() {
                ...
                if (affinity) {
                    factory = ThreadAffinity.forkJoinWorkerThreadFactory();
                }
                fjpSync = new ForkJoinPool(workers, factory, null, false);
                fjpAsync = new ForkJoinPool(workers, factory, null, true);
            }
...
//        @Benchmark
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
            .include(ForkJoinPoolForking.class.getSimpleName())
            .build();
